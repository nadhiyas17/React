...
function Rollspage() {
  const rolls=[{
    ...
    itemImg:"images/Chickenrolls/1.jpg",
    Price:600,
    Qty:1
  },
  {
    itemName:"Chicken Rolls",
    itemImg:"images/Chickenrolls/2.jpg",
    Price:300,
    Qty:1
  },
  {
    itemName:"Chicken Rolls",
    itemImg:"images/Chickenrolls/3.jpg",
    Price:800,
    Qty:1
  },
  {
    itemName:"Chicken Rolls",
    itemImg:"images/Chickenrolls/5.jpg",
    Price:150,
    Qty:1
  },
  ...
  return (
    <section className="Rolls shadow-lg w-100 p-2 " >
       <div className="row">
            <div className="col-3">
                <Sidebar/>  
              </div>  
...
<div className='col-9'>
      <h3 className="text-start mb-3 ">Chicken Rolls</h3>
